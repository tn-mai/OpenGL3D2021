...
まずUI表示用のグラフィックスパイプラインとサンプラーを準備します。`GameEngine.h`を開き、次のヘッダファイルをインクルードしてください。
...
次に、ゲームエンジンクラスに次のメンバ変数を追加してください。
...
追加したメンバ変数を初期化します。`GameEngine.cpp`を開き、イニシャライズ関数に次のプログラムを追加してください。
