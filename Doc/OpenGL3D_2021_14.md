...
+      }
+      // 選択アクターを配置する
+      target.reset(new Actor(cursor->name, cursor->prim, cursor->tex,
+        cursor->position, cursor->scale, cursor->rotation, cursor->adjustment));
...
<p align="center">
<img src="images/14_plane_segment_intersection.png" width="40%" />
</p>
