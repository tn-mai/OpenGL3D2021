...
```diff
   // 衝突判定用の変数.
   Collision collision;
+  void (*OnHit)(Actor&, Actor&, void*) = [](Actor&, Actor&, void*) {}; // 衝突解決関数へのポインタ.
...
-        animeList.push_back(&primitiveBuffer.Get(PrimNo::zombie_male_down_2));
-        animeList.push_back(&primitiveBuffer.Get(PrimNo::zombie_male_down_3));
+        animeList.push_back(&scene->primitiveBuffer.Get(PrimNo::zombie_male_down_0));
+        animeList.push_back(&scene->primitiveBuffer.Get(PrimNo::zombie_male_down_1));
+        animeList.push_back(&scene->primitiveBuffer.Get(PrimNo::zombie_male_down_2));
+        animeList.push_back(&scene->primitiveBuffer.Get(PrimNo::zombie_male_down_3));
               ・
               ・
               ・
         a.collision.shape = Collision::Shape::none;
