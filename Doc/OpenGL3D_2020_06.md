...
このとき`maxVertexCount`や`maxIndexCount`をキャストしているのは、左辺の`vertexCount`や`indexCount`と型を合わせるためです。もちろん、そんなことはまずありえませんが、しかし、バグというのは本来ありえない状況でこそ起きるものです。だから、十分に備えておくことが重要なのです。
