...
`Main.cpp`の`isEditMode`変数の値を`false`にして、作成したマップをプレイしてください。遠くに配置したはずの敵があっという間に近づいてきて囲まれてしまい、タコ殴りにあったと思います。

ここには、2つの問題が<ruby>潜<rt>ひそ</rt></ruby>んでいます。
